...
#   * <tt>True</tt>: Enable systemd support
#   * <tt>False</tt>: Disable systemd support
...
class conntrackd::config (
  ...
  Boolean                          $disable_external_cache     = $conntrackd::disable_external_cache,
  ...
  Optional[Boolean]                $systemd                    = $conntrackd::systemd,
